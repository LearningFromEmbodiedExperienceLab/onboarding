...
**Lookup.** Names, typical values, and longer notes for `PYTHONPATH`, CUDA, MuJoCo GL, `DISPLAY`, and the rest live in [Common environment variables](environment-variables.qmd#common-environment-variables) — use that chapter when you need a specific variable; this section is the concept only.
