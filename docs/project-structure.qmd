...
Puts `src/` on `sys.path`. Convenient for an afternoon, fragile: everyone must remember the same [environment variable](environment-variables.qmd#pythonpath), and IDEs / debuggers will not.
