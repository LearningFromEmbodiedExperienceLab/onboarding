...
```text
link / body
  ├── visual geoms     → pretty mesh (group 1 in MuJoCo)
  ├── collision geoms  → cheap/convex/compound (group 0, contype set)
...
*(To fill: `scripts/collision_debug.py` — load tutorial MJCF, print geom summary, optional
MuJoCo `mjVIS_GEOM` notes.)*
